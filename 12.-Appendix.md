...
* Odroid N2/+ - You must use the BOTTOM USB port that is closest to the DC power barrel jack. All other USB ports do not work. Also requires a high quality USB cable.
