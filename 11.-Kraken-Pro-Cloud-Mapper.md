...
1. To access the history feature, click the clock icon ![image](https://github.com/user-attachments/assets/c68594ff-a9b8-4f48-9ab2-51464c6a8c78) at the top, under your customer name, and then on the popup click 'Switch'.

2. Select the grouping, or individual KrakenSDRs that you would like to be part of the playback.

3. Select the timeframe that you would like to playback. Currently, 24 hours is the maximum length of time that can be selected.

4. Select the VFO Frequency that you would like to playback.

5. Select the heatmap decay time. Currently, choices of 1 minute to 10 minutes is possible.
...
![history_heatmap](https://github.com/user-attachments/assets/06615878-68b2-4e69-98a8-eba365684420)
